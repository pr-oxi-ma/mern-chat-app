const DEFAULT_AVATAR = "https://res.cloudinary.com/dpkzww5ki/image/upload/v1763080084/c2d3hp55h1nnm12omwjr.jpg"
const ACCEPTED_IMAGE_TYPES = ["image/jpeg", "image/jpg", "image/png"]
const ACCEPTED_FILE_MIME_TYPES = ["application/pdf","application/msword",...ACCEPTED_IMAGE_TYPES]

const APP_BRANDING_PROFILE_IMAGES = [
