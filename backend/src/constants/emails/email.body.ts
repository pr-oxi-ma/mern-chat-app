...
const welcomeEmailBody = (username: string) => {
    return emailLayout(`
    <p>Hello ${username},</p>
    <p>Welcome to Mernchat! We're excited to have you on board. Our application offers a range of features designed to enhance your communication experience:</p>
    <ul>
    ...
    <p>We're constantly working to improve Mernchat and add new features. If you have any questions or feedback, feel free to reach out to us at <a href="mailto:welcome.mernchat@gmail.com">welcome.mernchat@gmail.com</a>.</p>
...
const resetPasswordBody = (username: string, resetUrl: string) => {
    return emailLayout(`
        ...
        <p>If you continue to have trouble accessing your account, please contact our support team at <a href="mailto:welcome.mernchat@gmail.com">welcome.mernchat@gmail.com</a>.</p>
        <p>Thanks,</p>
...
const otpVerificationBody = (username: string, otp: string) => {
    return emailLayout(`
        <p>Hi ${username},</p>
        <p>A verification code is required to access your Mernchat account.</p>
...
const privateKeyRecoveryBody = (username:string,verificationUrl:string) => {
    return emailLayout(`
        <p>Hello ${username},</p>
        <p>We received a request to recover the private key associated with your Mernchat account. Your private key is essential for decrypting messages and ensuring the confidentiality of your communication.</p>
